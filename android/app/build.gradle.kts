...
android {
    ...
    packaging {
        jniLibs {
            ...
            // de visage, inspection de contenu, etc. Les exclure allège chaque
            // ABI d'~38 Mo (≈ -114 Mo sur l'APK admin universel, -38 Mo sur le
            // download Play Store de l'app user) sans impact fonctionnel.
            // ⚠️ Agora charge ces extensions à la demande ; non activées, leur
            // absence est inoffensive. Re-tester streaming + appels sur un build
            // RELEASE réel après toute modif de cette liste.
            excludes += setOf(
