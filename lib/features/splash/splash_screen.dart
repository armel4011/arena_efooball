// ════════════════════════════════════════════════════════════════════
// ARENA — Splash Screen Cinématique (Splash D) — 6.3s total
// ════════════════════════════════════════════════════════════════════
// Animation 5 phases :
...
//   Phase 4 (2.8s → 3.6s)  → 3 jeux supportés (cascade)
//   Phase 5 (5.7s → 6.3s)  → Fade out vers la route suivante
// ════════════════════════════════════════════════════════════════════
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void _initAnimations() {
    ...
    _sparkOpacity = TweenSequence<double>([
      ...
      TweenSequenceItem(tween: Tween<double>(begin: 0.6, end: 0), weight: 30),
    ]).animate(_sparkController);
  ...
  Future<void> _runSequence() async {
    ...
    // T=3.6s : Tout est affiché, on laisse admirer 2.1s.
    await Future<void>.delayed(const Duration(milliseconds: 2100));
    if (!mounted) return;

    // T=5.7s : Fade out 600ms
