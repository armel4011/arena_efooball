...
void main() {
  ...
  // Le dialogue de contrôle d'installation ne s'ouvre plus depuis la liste :
  // il s'affiche désormais AU-DESSUS du checkout (RegistrationConfirmPage). Il
  // reste couvert par app_check_dialog_test (le widget lui-même).
}
